...
class ANamespaceBuilder
  ...
  def build_global_namespace
    global_namespace = ANamespace.find_or_create_by(id: '\\', name: '\\')
    global_namespace.subnamespaces = build_subnamespaces
  ...
  def build_subnamespaces
    get_subnamespaces.map do |subnamespace|
      ANamespace.find_or_create_by(unique_name: get_subnamespace_unique_name(subnamespace), name: subnamespace.text)
    end
  end
